      ...
      <h2 style="color:white"> Mobile Shopping</h2> <br>
          <ol  v-for="itme in img " :key="itme" class="watch">
            ...
            <div class="container d-flex justify-content-center">
              <figure class="card card-product-grid card-lg"> <a href="#" class="img-wrap" data-abc="true"> <img :src="itme.thumbnail"> </a>
                  <figcaption class="info-wrap">
                      <div class="row">
                          <div class="col-md-9 col-xs-9"> <a href="#" class="title" data-abc="true">{{ itme.title }}</a> <span class="rated">Laptops</span> </div>
                          <div class="col-md-3 col-xs-3">
                              <div class="rating text-right"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <span class="rated">{{ itme.rating }}</span> </div>
                          </div>
                      </div>
                  </figcaption>
                  <div class="bottom-wrap-payment">
                      <figcaption class="info-wrap">
                          <div class="row">
                              <div class="col-md-9 col-xs-9"> <a href="#" class="title" data-abc="true">{{ itme.price }}</a> <span class="rated">VISA Platinum</span> </div>
                              <div class="col-md-3 col-xs-3">
                                  <div class="rating text-right"> ID:{{itme.id}}</div>
                              </div>
                          </div>
                      </figcaption>
                  </div>
...
let project = json.products;
console.log(this.img=project);
    },
    methods: {
      counting(){
        this.count++
